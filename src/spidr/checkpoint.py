...
class Checkpointer:
    def __init__(self, folder: Path, interval: int, keep_latest: int = -1, *, disable: bool = False) -> None:
        ...
        self._metrics_queue = MetricsQueue(self.folder / "metrics.jsonl", interval)
